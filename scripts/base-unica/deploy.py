...
FILES=['20260916235000_base_clientes_sync.sql','20260917000000_base_unica_catalogo.sql','20260917010000_base_ecd_metadata.sql','20260917011000_base_vinculos_conflitantes.sql','20260917012000_base_clientes_acesso.sql']
def schemas():
