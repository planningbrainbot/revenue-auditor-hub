...
export const KNOWN_PERMISSIONS: { key: string; label: string; description: string; group: string }[] = [
  ...
  { key: "view.painel_cs", label: "Acessar CS", description: "Página unificada de CS — Onboarding (pipe Pipefy), Saúde da Carteira e Tratativas.", group: "Acesso" },
  { key: "view.nps", label: "Acessar NPS", description: "Análise das respostas da pesquisa de satisfação — NPS/CSAT, evolução, por unidade e respostas individuais.", group: "Acesso" },
  { key: "view.disparos_whatsapp", label: "Acessar Disparos de WhatsApp", description: "Estrutura de disparo em massa via WhatsApp e acompanhamento de status (enviado/entregue/lido/falhou) — usada hoje pelo NPS, mas genérica pra qualquer campanha.", group: "Acesso" },
  { key: "view.base_contatos", label: "Acessar Base de Contatos", description: "Cobertura de contato de WhatsApp por unidade e plano de ação do CS pra completar cadastro de contatos faltantes.", group: "Acesso" },
