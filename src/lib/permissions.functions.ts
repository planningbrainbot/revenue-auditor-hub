...
export const KNOWN_PERMISSIONS: { key: string; label: string; description: string; group: string }[] = [
  ...
  { key: "view.nps", label: "Acessar NPS", description: "Pesquisa de satisfação via WhatsApp — cobertura da base, painel analítico (NPS/CSAT) e acompanhamento dos disparos.", group: "Acesso" },
